...
export const Glass = {
  ...
  // Replaced black glass, restoring previous navy glass values.
  dark: {
    // background: 'rgba(0,0,0,0.75)',
    background: 'rgba(11,17,32,0.7)',
    // backgroundStrong: 'rgba(0,0,0,0.92)',
    backgroundStrong: 'rgba(20,29,46,0.92)',
    // border: 'rgba(255,255,255,0.08)',
    border: 'rgba(30,45,69,0.5)',
    // borderStrong: 'rgba(255,255,255,0.14)',
    borderStrong: 'rgba(30,45,69,0.75)',
    intensity: 60,
  },
};
...
export const Gradients = {
  ...
  primary: ['#0B1120', '#141D2E'] as const,
  // dark: ['#000000', '#1A1A1A'] as const,
  dark: ['#0B1120', '#141D2E'] as const,
  // button: ['#0A9E6E', '#1ABC93', '#44D9B8'] as const,
  button: ['#1E3A8A', '#3B82F6', '#60A5FA'] as const,
};

// Previous navy/dark-blue theme colors (preserved for easy rollback):
// dark.background: '#0B1120', dark.cardSolid: '#141D2E', dark.divider: '#1E2D45', dark.inputBg: '#1A2540'
export const Colors = {
  light: {
